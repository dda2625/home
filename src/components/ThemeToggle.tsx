...
export default function ThemeToggle() {
    ...
    return (
        <button className="text-xl" onClick={handleClick} aria-label="Toggle between dark and light mode">
        {
            theme === "light" 
            ? 
            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 dark:stroke-white stroke-white">
            ...
            :
            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 dark:stroke-white stroke-black">
